...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/yisheng/webframe/index.php/Admin/File/ajaxIndex",
					//cache: false,
		...
		*/
		function add(){
			var index = layer.open({
						...
						content: ['/yisheng/webframe/index.php/Admin/File/add', 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(file_title==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/File/dataInsert',
									data: obj.serialize(),
									cache: false,
		...
		*/
		function delmore(file_id){
			layer.confirm('	确定要删除吗？', {
					...
					var actionUrl = "/yisheng/webframe/index.php/Admin/File/del";
						$.ajax({
						type: 'post',
								url: actionUrl,
								data: {ids:ids},
