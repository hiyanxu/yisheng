...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/yisheng/webframe/index.php/Admin/News/newsCateAjaxIndex",
					//cache: false,
		...
		*/
		function add(){
			var index = layer.open({
						...
						content: ['/yisheng/webframe/index.php/Admin/News/cateSelect', 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(cate_id==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/News/cateSelectInsert',
									data: obj.serialize(),
									cache: false,
		...
		*/
		function setNewsCate(id,flag){
			$.ajax({
				...
				url:"/yisheng/webframe/index.php/Admin/News/setNewsCateIsEnable",
				success:function(data){
					if (data.status) {
											layer.msg("设置成功", {
											icon: 1,
		...
		*/
		function delmore(id){
			layer.confirm('	确定要删除吗？', {
					...
					var actionUrl = "/yisheng/webframe/index.php/Admin/News/newsCatedel";
						$.ajax({
						type: 'post',
								url: actionUrl,
								data: {id:id},
