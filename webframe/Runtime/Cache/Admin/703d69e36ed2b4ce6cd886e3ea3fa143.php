...
<html>
	...
	<body>
		...
		function load(){
			var result="";
			var actionUrl="/webframework/webframe/index.php/Admin/Role/getMenuTree";
			$.ajax({
				type:"post",
				url:actionUrl,
		...
		function tree_data(){
			...
			jQuery(function($) {
				// ------------------------------------------------------  组织树 的 json数据 
                    ...
                    var treeDataSource = '';
                    $.ajax({
                    	url: '/webframework/webframe/index.php/Admin/Role/getMenuTree',
                    	type: 'GET',
                        dataType: 'json',
				...
				$.ajax({
					...
					success:function(data){
						 if (data.status) {
											...
											window.location.href="/webframework/webframe/index.php/Admin/Role/index";
										} else {
											layer.msg(data.msg, {
											icon: 3,
												time: 1000,
