		...
		<div>
			<div class="modal-body">
				<form id="wt-forms" method="post" tabindex="-1" onsubmit="return false;" class="form-horizontal">
					<input type="hidden" value="<?php echo ($row['0']['menu_id']); ?>" name="parentid">
                    <div class="form-group">
                        <label class="col-xs-3 control-label">父级菜单名称：</label>
                        <div class="col-xs-8">
                            <input type="text" value="<?php echo ($row['0']['menu_name']); ?>" readonly="readonly" class="form-control input-sm"> 
                        </div>
                    </div>
                    <div class="form-group">
