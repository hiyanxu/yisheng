...
<html>
	...
	<body>
		...
		function load(){
			var result="";
			var actionUrl="/webframework/webframe/index.php/Admin/Org/getOrgTree";
			$.ajax({
				type:"post",
				url:actionUrl,
		...
		*/
		function add(){
			var index=layer.open({
					...
					shadeClose:true,
					shift:0,
					content:["/webframework/webframe/index.php/Admin/Org/add","no"],
					btn:['确定','取消'],
					yes:function(index){
						...
						var actionUrl="/webframework/webframe/index.php/Admin/Org/insert";
						$.ajax({
							type:"post",
							url:actionUrl,
							data:obj.serialize(),
		...
		*/
		function addChild(fid){
			var index=layer.open({
				...
				shadeClose:true,
				shift:0,
				content:['/webframework/webframe/index.php/Admin/Org/addChild/fid/'+fid,'no'],
				btn:['确定','取消'],
				yes:function(index){
					var obj=layer.getChildFrame("#wt-forms",index);
						var name=obj.find("#org_name").val()
		...
		*/
		function editChild(org_id){
			var index=layer.open({
				...
				shadeClose:true,
				shift:0,
				content:['/webframework/webframe/index.php/Admin/Org/edit/org_id/'+org_id],
				btn:['确定','取消'],
				yes:function(index){
					var obj=layer.getChildFrame("#wt-forms",index);
						var name=obj.find("#org_name").val()
						...
						var actionUrl="/webframework/webframe/index.php/Admin/Org/update";
						$.ajax({
							type:"post",
							url:actionUrl,
							data:obj.serialize(),
		...
		*/
		function delChild(org_id){
			layer.confirm("确定要删除吗?",{btn:["确定","取消"]},function(index,layero){
					var actionUrl="/webframework/webframe/index.php/Admin/Org/del";
					$.ajax({
						type:"post",
						url:actionUrl,
						data:{"org_id":org_id},
