            ...
            <div class="modal-body">
                <form id="wt-forms" method="post" tabindex="-1" onsubmit="return false;" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-xs-3 control-label">上级机构名称：</label>
                        <div class="col-xs-8">
                            <input type="text" value="<?php echo ($row[0]['org_name']); ?>" readonly="readonly" class="form-control input-sm"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">机构名称：</label>
                        <div class="col-xs-8">
                            <input type="text" id="org_name" name="org_name" class="form-control input-sm"> 
                        </div>
                    </div>
                    <div class="form-group">
