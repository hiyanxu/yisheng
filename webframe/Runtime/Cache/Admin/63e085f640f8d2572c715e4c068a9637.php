...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/yisheng/webframe/index.php/Admin/Useraccount/ajaxIndex",
					//cache: false,
		...
		*/
		function add(){
			var index = layer.open({
						...
						content: ['/yisheng/webframe/index.php/Admin/Useraccount/add', 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(user_account==""||user_pwd==""){
							layer.msg("数据不可为空", {
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/Useraccount/insert',
									data: obj.serialize(),
									cache: false,
		...
		*/
		function edit(user_account_id){
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/Useraccount/edit/user_account_id/'+user_account_id, 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						var obj = layer.getChildFrame('#wt-forms', index); //获取form的值
						var user_account=obj.find("#user_account").val();
						...
						if(user_account==""||user_pwd==""){
							layer.msg("数据不可为空", {
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/Useraccount/update',
									data: obj.serialize(),
									cache: false,
									success: function (data) {
										if (data.status) {
		...
		*/
		function delmore(user_account_id){
			layer.confirm('	确定要删除吗？', {
					...
					var actionUrl = "/yisheng/webframe/index.php/Admin/Useraccount/del";
						$.ajax({
						type: 'post',
								url: actionUrl,
								data: {ids:ids},
		...
		*/
		function editPwd(user_account_id){
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/Useraccount/editPwd/user_account_id/'+user_account_id, 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(user_pwd==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/Useraccount/editPwdSave',
									data: obj.serialize(),
									cache: false,
									success: function (data) {
										if (data.status) {
