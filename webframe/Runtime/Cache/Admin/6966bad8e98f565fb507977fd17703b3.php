...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/webframework/webframe/index.php/Admin/News/newsWorkflowAjaxIndex",
					//cache: false,
		...
		*/		
		function add(){
			var index = layer.open({
						...
						content: ['/webframework/webframe/index.php/Admin/News/workSelect', 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(workflow_id==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/webframework/webframe/index.php/Admin/News/workflowSelectInsert',
									data: obj.serialize(),
									cache: false,
		...
		*/
		function setNewsWorkflow(id,flag){
			$.ajax({
				...
				url:"/webframework/webframe/index.php/Admin/News/setNewsWorkflowIsEnable",
				success:function(data){
					if (data.status) {
											layer.msg("设置成功", {
											icon: 1,
		...
		*/
		function delmore(id){
			layer.confirm('	确定要删除吗？', {
					...
					var actionUrl = "/webframework/webframe/index.php/Admin/News/newsWorkflowedel";
						$.ajax({
						type: 'post',
								url: actionUrl,
								data: {id:id},
