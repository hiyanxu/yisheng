        ...
        <div>
            <div class="modal-body">
                <form id="wt-forms" method="post" tabindex="-1" onsubmit="return false;" class="form-horizontal">
                    <input type="hidden" value="<?php echo ($data[0]['lec_id']); ?>" name="lec_id">
                    <div class="form-group">
                        <label class="col-xs-3 control-label">讲座名称：</label>
                        <div class="col-xs-8">
                            <input type="text" id="lec_name" name="lec_name" value="<?php echo ($data[0]['lec_name']); ?>" placeholder="请给出讲座名称" class="form-control input-sm"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">讲座时间：</label>
                        <div class="col-xs-8">
                            <input type="text" id="lec_time" name="lec_time" value="<?php echo ($data[0]['lec_time']); ?>" onclick="WdatePicker()" placeholder="请单击" class="form-control input-sm"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">主讲人：</label>
                        <div class="col-xs-8">
                            <input type="text" name='lec_speaker' value="<?php echo ($data[0]['lec_speaker']); ?>" class="form-control input-sm" placeholder="请输入主讲人">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <select name="lec_duty">
                                <?php if(is_array($cate_rows)): foreach($cate_rows as $k=>$cate_row): ?><option value="<?php echo ($cate_row['cate_id']); ?>" <?php if($data[0]['lec_duty'] == $cate_row['cate_id']): ?>selected="selected"<?php endif; ?>><?php echo ($cate_row['cate_name']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <select name="lec_speaker_college">
                                <?php if(is_array($org_rows)): foreach($org_rows as $k=>$org_row): ?><option value="<?php echo ($org_row['org_id']); ?>" <?php if($data[0]['lec_speaker_college'] == $org_row['org_id']): ?>selected="selected"<?php endif; ?>><?php echo ($org_row['org_name']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <select name="lec_workshop">
                                <?php if(is_array($workshop_rows)): foreach($workshop_rows as $k=>$workshop_row): ?><option value="<?php echo ($k); ?>" <?php if($data[0]['lec_workshop'] == $k): ?>selected="selected"<?php endif; ?>><?php echo ($workshop_row); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <select name="lec_college">
                                <?php if(is_array($org_rows)): foreach($org_rows as $k=>$org_row): ?><option value="<?php echo ($org_row['org_id']); ?>" <?php if($data[0]['lec_college'] == $org_row['org_id']): ?>selected="selected"<?php endif; ?>><?php echo ($org_row['org_name']); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" name='lec_place' class="form-control input-sm" value="<?php echo ($data[0]['lec_place']); ?>" placeholder="请输入讲座地点">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <textarea name="lec_content" id="lec_content" plcaeholder="请给出内容"><?php echo ($data[0]['lec_content']); ?></textarea>
                        </div>
                    </div>
