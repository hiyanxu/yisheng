...
<html>
	...
	$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/webframework/webframe/index.php/Admin/Behaviorlog/ajaxIndex",
					//cache: false,
					...
					columns: [{
						...
						field: 'behavior_log_id',
						title: 'ID',
						align: 'center', //
						valign: 'middle',
						sortable: true  //是否排序
					}, {
						field: 'behavior_log_account',
						title: '操作账号',
						// visible: false, //刚开始是否显示此字段
						//sortable: false  //是否排序
					}, {
						field: 'behavior_log_route',
						title: '操作路由',
						// visible: false, //刚开始是否显示此字段
						//sortable: true  //是否排序
					}, {
						field: 'behavior_log_time',
						title: '操作时间',
						// visible: false, //刚开始是否显示此字段
						//sortable: true  //是否排序
					}, {
						field: 'behavior_log_ip',
						title: '操作ip',
						// visible: false, //刚开始是否显示此字段
						//sortable: true  //是否排序
					}],
