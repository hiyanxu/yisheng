...
<html>
	...
	<body>
		<div id="page-content">
			<div id="main-container container-fluid" style="margin-left:40px;">
				<div id="headshow" >
					授课讲师：<label><?php echo ($course_speaker); ?></label>
					课程名称：<label><?php echo ($course_name); ?></label>
				</div>
	...
	$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/yisheng/webframe//index.php/Admin/Course/ajaxSelectStuIndex/course_id/"+course_id,
					//cache: false,
