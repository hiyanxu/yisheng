...
<html>
	...
	<body>
		...
		function load(){
			var result="";
			var actionUrl="/webframework/webframe/index.php/Admin/Cate/getCateTree";
			$.ajax({
				type:"post",
				url:actionUrl,
		...
		*/
		function add(){
			var index=layer.open({
					...
					shadeClose:true,
					shift:0,
					content:["/webframework/webframe/index.php/Admin/Cate/add","no"],
					btn:['确定','取消'],
					yes:function(index){
						...
						var actionUrl="/webframework/webframe/index.php/Admin/Cate/insert";
						$.ajax({
							type:"post",
							url:actionUrl,
							data:obj.serialize(),
		...
		*/
		function addChild(fid){
			var index=layer.open({
				...
				shadeClose:true,
				shift:0,
				content:['/webframework/webframe/index.php/Admin/Cate/addChild/fid/'+fid,'no'],
				btn:['确定','取消'],
				yes:function(index){
					var obj=layer.getChildFrame("#wt-forms",index);
						var name=obj.find("#cate_name").val()
		...
		*/
		function editChild(cate_id){
			var index=layer.open({
				...
				shadeClose:true,
				shift:0,
				content:['/webframework/webframe/index.php/Admin/Cate/edit/cate_id/'+cate_id],
				btn:['确定','取消'],
				yes:function(index){
					var obj=layer.getChildFrame("#wt-forms",index);
						var name=obj.find("#cate_name").val()
						...
						var actionUrl="/webframework/webframe/index.php/Admin/Cate/update";
						$.ajax({
							type:"post",
							url:actionUrl,
							data:obj.serialize(),
		...
		*/
		function delChild(cate_id){
			layer.confirm("确定要删除吗?",{btn:["确定","取消"]},function(index,layero){
					var actionUrl="/webframework/webframe/index.php/Admin/Cate/del";
					$.ajax({
						type:"post",
						url:actionUrl,
