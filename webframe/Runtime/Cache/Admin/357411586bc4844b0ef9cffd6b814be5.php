		...
		*/
		function add(){
			...
			var index = layer.open({
						...
						content: ['/yisheng/webframe/index.php/Admin/User/add/isAdmin/1', 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
		...
		*/
		function edit(user_id,user_account_id){
			...
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/User/edit/isAdmin/1/user_id/'+user_id+'/user_account_id/'+user_account_id, 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
