        ...
        <div>
            <div class="modal-body">
                <form id="wt-forms" method="post" tabindex="-1" onsubmit="return false;" class="form-horizontal">
                    <input type="hidden" value="<?php echo ($data[0]['open_id']); ?>" name="open_id">
                    <div class="form-group">
                        <label class="col-xs-3 control-label">开放日主题：</label>
                        <div class="col-xs-8">
                            <input type="text" id="open_theme" name="open_theme" value="<?php echo ($data[0]['open_theme']); ?>" placeholder="请给出开放日主题" class="form-control input-sm"> 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" id="open_start" name="open_start" value="<?php echo ($data[0]['open_start']); ?>" onclick="WdatePicker()" placeholder="请单击" class="form-control input-sm"> 
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">结束时间：</label>
                        <div class="col-xs-8">
                            <input type="text" id="open_end" name="open_end" value="<?php echo ($data[0]['open_end']); ?>" onclick="WdatePicker()" placeholder="请单击" class="form-control input-sm"> 
                        </div>
                    </div>
                    ...
                    <div id="file_upload" class="form-group">
                        ...
                        <div id="divupload0">
                            <div style="float:left;">
                                <input type="text"  name ="open_thumb" id="open_thumb" value="<?php echo ($data[0]['open_thumb']); ?>" class="input-xlarge"/>   
                            </div>
                            <div style="float:left;">
                                <i id="pickfiles"></i>  
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" name='open_location' id="open_location" value="<?php echo ($data[0]['open_location']); ?>" class="form-control input-sm" placeholder="请给出开放日地点">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <select name="open_workshop">
                                <?php if(is_array($workshop_rows)): foreach($workshop_rows as $k=>$workshop_row): ?><option value="<?php echo ($k); ?>" <?php if($data[0]['open_workshop'] == $k): ?>selected="selected"<?php endif; ?>><?php echo ($workshop_row); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <textarea name="open_content" id="open_content" plcaeholder="请给出内容"><?php echo ($data[0]['open_content']); ?></textarea>
                        </div>
                    </div>
