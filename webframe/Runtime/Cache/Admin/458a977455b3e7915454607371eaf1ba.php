...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/yisheng/webframe/index.php/Admin/User/ajaxIndex",
					//cache: false,
		...
		*/
		function add(){
			...
			var index = layer.open({
						...
						content: ['/yisheng/webframe/index.php/Admin/User/add/isAdmin/0', 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(user_name=="admin"){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/User/insert',
									data: obj.serialize(),
									cache: false,
		...
		*/
		function edit(user_id,user_account_id){
			...
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/User/edit/isAdmin/0/user_id/'+user_id+'/user_account_id/'+user_account_id, 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(user_name=="admin"){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/User/update',
									data: obj.serialize(),
									cache: false,
									success: function (data) {
										if (data.status) {
		...
		*/
		function delmore(user_id,user_account_id){
			layer.confirm('确定要删除吗？', {
					...
					var actionUrl = "/yisheng/webframe/index.php/Admin/User/del";
						$.ajax({
						type: 'post',
								url: actionUrl,
		...
		*/
		function editPwd(user_account_id){
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/User/editPwd/user_account_id/'+user_account_id, 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(user_pwd==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/User/editPwdSave',
									data: obj.serialize(),
									cache: false,
									success: function (data) {
										if (data.status) {
