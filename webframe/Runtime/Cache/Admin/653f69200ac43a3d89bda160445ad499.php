        ...
        <div>
            <div class="modal-body">
                <form id="wt-forms" method="post" tabindex="-1" onsubmit="return false;" class="form-horizontal">
                    <input type="hidden" value="<?php echo ($row[0]['access_id']); ?>" name="access_id">
                    <div class="form-group">
                        <label class="col-xs-3 control-label">权限名称：</label>
                        <div class="col-xs-8">
                            <input type="text" id="access_name" name="access_name" value="<?php echo ($row[0]['access_name']); ?>" placeholder="请输入权限名称" class="form-control input-sm">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">对应控制器：</label>
                        <div class="col-xs-8">
                            <input type="text" id="access_con" name="access_con" placeholder="请输入对应控制器名（不包括Controller）" value="<?php echo ($row[0]['access_con']); ?>" class="form-control input-sm">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">对应方法：</label>
                        <div class="col-xs-8">
                            <input type="text" id="access_fun" name="access_fun" placeholder="请输入控制器中对应方法" value="<?php echo ($row[0]['access_fun']); ?>" class="form-control input-sm">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-3 control-label">备注信息：</label>
                        <div class="col-xs-8">
                            <textarea cols="70" name="remark" placeholder="请输入备注信息" rows="5"><?php echo ($row[0]['remark']); ?></textarea>
                        </div>
                    </div>
