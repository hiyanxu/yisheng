...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/yisheng/webframe/index.php/Admin/Access/ajaxIndex",
					//cache: false,
		...
		*/
		function add(){
			var index = layer.open({
						...
						content: ['/yisheng/webframe/index.php/Admin/Access/add', 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(access_name==""||access_con==""||access_fun==""){
							layer.msg("数据不可为空", {
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/Access/insert',
									data: obj.serialize(),
									cache: false,
		...
		*/
		function edit(access_id){
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/Access/edit/access_id/'+access_id, 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(access_name==""||access_con==""||access_fun==""){
							layer.msg("数据不可为空", {
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/Access/update',
									data: obj.serialize(),
									cache: false,
									success: function (data) {
										if (data.status) {
		...
		*/
		function delmore(access_id){
			layer.confirm('	确定要删除吗？', {
					...
					var actionUrl = "/yisheng/webframe/index.php/Admin/Access/del";
						$.ajax({
						type: 'post',
								url: actionUrl,
								data: {ids:ids},
