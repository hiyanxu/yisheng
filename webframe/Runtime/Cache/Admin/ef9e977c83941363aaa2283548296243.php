        ...
        <div>
            <div class="modal-body">
                <form id="wt-forms" method="post" tabindex="-1" onsubmit="return false;" class="form-horizontal">
                    <input type="hidden" value="<?php echo ($lec_id); ?>" name="lec_id">
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" id="lec_link" name="lec_link" value="<?php echo ($row[0]['lec_link']); ?>" placeholder="请输入新闻链接" class="form-control input-sm"> 
                        </div>
                    </div>
                    <div id="file_upload" class="form-group">
                        ...
                        <div id="divupload0">
                            <div style="float:left;">
                                <input type="text" value="<?php echo ($row[0]['lec_thumb']); ?>"  name ="lec_thumb" id="lec_thumb" class="input-xlarge"/>   
                            </div>
                            <div style="float:left;">
                                <i id="pickfiles2"></i>  
                            </div>
                    ...
                    <div id="file_upload" class="form-group">
                        ...
                        <div id="divupload0">
                            <div style="float:left;">
                                <input type="text" value="<?php echo ($row[0]['lec_ppt']); ?>"  name ="lec_ppt" id="lec_ppt" class="input-xlarge"/>   
                            </div>
                            <div style="float:left;">
                                <i id="pickfiles"></i>  
                            </div>
     ...
     <!--上传部分js代码-->
        ...
        function upload_init(fileext,fileDesc){
            $('#pickfiles').uploadify({
                ...
                'uploader': '/yisheng/webframe/index.php/Admin/Lecture/uploader', // 服务器端处理程序                
