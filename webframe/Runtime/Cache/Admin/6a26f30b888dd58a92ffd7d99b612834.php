...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/yisheng/webframe/index.php/Admin/News/ajaxIndex",
					//cache: false,
		...
		*/		
		function add(){
			var index = layer.open({
						...
						content: ['/yisheng/webframe/index.php/Admin/News/add', 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(news_name==""||news_time==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/News/insert',
									data: obj.serialize(),
									cache: false,
		...
		*/
		function edit(news_id){
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/News/edit/news_id/'+news_id, 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(news_name==""||news_time==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/News/update',
									data: obj.serialize(),
									cache: false,
									success: function (data) {
										if (data.status) {
		...
		*/
		function sendEx(news_id){
			$.ajax({
				...
				url:"/yisheng/webframe/index.php/Admin/News/sendEx",
				success:function(data){
					if (data.status) {
											layer.msg(data.msg, {
											icon: 1,
		...
		*/
		function examine(news_id){
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/yisheng/webframe/index.php/Admin/News/getExamine/news_id/'+news_id, 'yes'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						if(news_name==""||news_time==""){
							...
							return;
								...
								$.ajax({
									type: 'post',
									url: '/yisheng/webframe/index.php/Admin/News/examine',
									data: obj.serialize(),
									cache: false,
									success: function (data) {
										if (data.status) {
		...
		*/
		function delmore(news_id){
			layer.confirm('确定要删除吗？', {
					...
					var actionUrl = "/yisheng/webframe/index.php/Admin/News/del";
						$.ajax({
						type: 'post',
								url: actionUrl,
								data: {ids:ids},
