...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/webframework/webframe/index.php/Admin/Menu/childAjaxIndex",
					//cache: false,
			...
			*/
			function add(){
				...
				var index = layer.open({
						...
						content: ['/webframework/webframe/index.php/Admin/Menu/addChild/menu_id/'+menu_id, 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
						...
						var obj = layer.getChildFrame('#wt-forms', index); //获取form的值
								$.ajax({
									type: 'post',
									url: '/webframework/webframe/index.php/Admin/Menu/insert',
									data: obj.serialize(),
									cache: false,
			...
			*/
			function back(){
				...
				window.location.href="/webframework/webframe/index.php/Admin/Menu/back/parentid/"+parentid;
			}
			...
			*/
			function getchild(id){
				window.location.href="/webframework/webframe/index.php/Admin/Menu/getchild/id/"+id;
			}
			...
			*/
			function edit(menu_id){
				var index = layer.open({
							...
							// time:1000,  设置自动关闭窗口时间 1秒=1000；
							shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
							content: ['/webframework/webframe/index.php/Admin/Menu/editChild/menu_id/'+menu_id, 'no'],
							btn: ['确定', '取消']
							, yes: function (index) {
							...
							var obj = layer.getChildFrame('#wt-forms', index); //获取form的值
									$.ajax({
										type: 'post',
										url: '/webframework/webframe/index.php/Admin/Menu/update',
										data: obj.serialize(),
										cache: false,
										success: function (data) {
											if (data.status) {
			...
			*/
			function delmore(menu_id){
				layer.confirm('确定要删除该菜单以及其子菜单吗？', {
						...
						var actionUrl = "/webframework/webframe/index.php/Admin/Menu/del";
							$.ajax({
							type: 'post',
									url: actionUrl,
									data: {ids:ids},
