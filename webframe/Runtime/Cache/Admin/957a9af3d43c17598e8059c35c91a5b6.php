...
<html>
	...
	<body>
		...
		$('#table').bootstrapTable({
					...
					method: 'get',
					url: "/webframework/webframe/index.php/Admin/Menu/ajaxIndex",
					//cache: false,
		...
		*/
		function add(){
			...
			var index = layer.open({
						...
						content: ['/webframework/webframe/index.php/Admin/Menu/add', 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
		...
		*/
		function edit(menu_id){
			var index = layer.open({
						...
						// time:1000,  设置自动关闭窗口时间 1秒=1000；
						shift: 0, //打开效果：0-6 。0放大，1从上到下，2下到上，3左到右放大，4翻滚效果；5渐变；6抖窗口
						content: ['/webframework/webframe/index.php/Admin/Menu/edit/menu_id/'+menu_id, 'no'],
						btn: ['确定', '取消']
						, yes: function (index) {
